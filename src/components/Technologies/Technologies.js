...
const Technologies = () =>  (
  <Section id="tech">
    ...
    <SectionText><br/>
      Fullstack: HTML, CSS, Sass, Bootstrap, JavaScript, React, React Hooks, React Router, Redux, Styled Components, Next.js, TypeScript, Angular, RxJS, NgRx, Ionic, React Native, React Native Paper<br/><br/>
